    ...
    while nodes_to_visit:
        ...
        if current_node == goal_node:
            ...
            while current_node != start_node:
                # error(f"Current tile : {current_node.tile}")
...
class Game:
    ...
    def optimal_pathing(self):
        genetic_algo = Population(0.01, 100, 20, 0.2, self.board.grid)
...
class Population:
    ...
    def _random_path(start_tile: Tile):
        ...
        while length_path < HEIGHT * WIDTH:
            next_tile = choice(list(current_tile.neighbors))
